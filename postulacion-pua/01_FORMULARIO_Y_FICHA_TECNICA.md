# 01 · Formulario y ficha técnica del proyecto

> Datos para volcar al formulario en línea del PUA. Los campos con `‹BORRADOR›` / `‹A CONFIRMAR›`
> deben ajustarse a los datos reales antes de enviar.
...
| País | Uruguay (producción 100 % nacional) |
...
> onírica, emprende un viaje interior sobre el pensar, la paternidad y el aprender a soltar.

## 3. Autoría y dirección
...
| **Louie / Robson (Rob)** | Hijos de Milton. | ‹A CONFIRMAR› |
| **Monika Kloss** | Psicóloga vienesa (protocolo de la línea de ayuda). | ‹A CONFIRMAR› |
| **Madre 1** | Madre uruguaya residente en Viena; pianista. | ‹A CONFIRMAR› |
| **Robert** | Chofer de la Academia Vienesa de Medicina. | ‹A CONFIRMAR› |
| **Daphne / Esther / Frank / Buffy** | Personajes secundarios del recorrido vienés y de la odisea. | ‹A CONFIRMAR› |

## 7. Cifras de cabecera (resumen — detalle en doc. 06) ‹BORRADOR›
