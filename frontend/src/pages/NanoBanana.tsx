...
export default function NanoBanana({ comfyUrl = "" }: Props) {
  // State
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <div className="flex gap-6 p-6 md:p-10">
        ...
        <div className="flex-1 max-w-4xl space-y-8">
          <div className="text-center space-y-4 py-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto leading-relaxed">
              Upload an image and describe the edits you want. Powered by OpenRouter AI.
            </p>
          </div>
        ...
        <ResizableFeedSidebar
          storageKey="nano-banana"
          config={{
            mediaType: 'all',
            pageContext: ['image-edit', 'nano-banana'],
