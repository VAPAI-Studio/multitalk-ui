...
interface Props {
  onNavigate: (page: "lipsync" | "image-edit" | "character-caption" | "wan-i2v" | "wan-move" | "ltx2-i2v" | "style-transfer" | "create-image" | "lora-trainer" | "image-grid" | "img2img" | "generation-feed") => void;
}
