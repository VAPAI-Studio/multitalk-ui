...
export default function App() {
  const [currentPage, setCurrentPage] = useState<"home" | "multitalk-one" | "multitalk-multiple" | "video-lipsync" | "image-edit" | "character-caption">("home");
        ...
        <div className={`fixed inset-y-0 left-0 z-50 flex transition-all duration-300 ease-in-out ${
          ...
          <div className="flex flex-col w-80 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-700/50 shadow-2xl">
            ...
            <div className="flex-1 p-6 space-y-2">
              ...
              <button
                onClick={() => { setCurrentPage("multitalk-one"); setSidebarOpen(false); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              ...
              <button
                onClick={() => { setCurrentPage("multitalk-multiple"); setSidebarOpen(false); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              ...
              <button
                onClick={() => { setCurrentPage("video-lipsync"); setSidebarOpen(false); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              ...
              <button
                onClick={() => { setCurrentPage("image-edit"); setSidebarOpen(false); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
              ...
              <button
                onClick={() => { setCurrentPage("character-caption"); setSidebarOpen(false); }}
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-left transition-all duration-200 ${
